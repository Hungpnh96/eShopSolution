...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<ProductVm> GetById(int productId, string languageId)
        {
            ...
            var categoríe =await (from c in _context.Categories 
        ...
        public async Task<int> UpdateImage(ProductImageUpdateRequest request)
        {
            ...
            {
                throw new EShopException($"Can't find an image with id: {request.Id}");
            }
        ...
        public async Task<ApiResult<bool>> CategoryAssign(int Id, CategoryAssignRequest request)
        {
            ...
            //xóa các loại danh mục sản phẩm theo danh sách đã lấy
