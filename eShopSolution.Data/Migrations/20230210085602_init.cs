    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "cf6835a4-f59b-46f5-9a61-3b2cf6055efb", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "4e741bf1-84d0-4e9d-8d99-441e729b0d47", new DateTime(1995, 12, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "hungpnh96@gmail.com", true, "Hung", false, null, "hungpnh96@gmail.com", "admin", "AQAAAAEAACcQAAAAENOzBSf3/P2fqGkUB2mvDT0zYkNHerOxSNI/lTqqSZkN2t2O9diogqjvG9SUzwFXZQ==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 2, 10, 15, 56, 2, 492, DateTimeKind.Local).AddTicks(9531), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Sản phẩm 1", "San-pham-1", "Sản phẩm 1", "Sản phẩm 1" },
                    { 3, 2, "vi", "Sản phẩm 2", "San-pham-2", "Sản phẩm 2", "Sản phẩm 2" },
                    { 2, 1, "en", "Product Name 1", "Product-name-1", "The products name 1", "The products name 1" },
                    { 4, 2, "en", "Product Name 2", "Product-Name-2", "The Product Name 2", "The Product Name 2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sản phẩm 1", "Sản phẩm 1", "vi", "Sản phẩm 1", 1, "San-pham-1", "Sản phẩm 1", "Sản phẩm 1" },
                    { 2, "Product Name 1", "Product Name 1", "en", "Product Name 1", 1, "Product-name-1", "Product Name 1", "Product Name 1" }
                });
