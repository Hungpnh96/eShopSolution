    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "0f6ae045-4ae7-4713-beb2-6217e311af6b", "Administrator role", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "cadf680a-43c3-4398-be5a-d2ecc7e31876", new DateTime(1995, 12, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "hungpnh96@gmail.com", true, "Hung", "Pham", false, null, "hungpnh96@gmail.com", "admin", "AQAAAAEAACcQAAAAEAjaITaAJ+1Xe+Rmwm19jUAlWfTJ9UyiXVm+ZnifCRJHCOPi3qJvu0IWhNcqHFenkg==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 3, 9, 58, 56, 313, DateTimeKind.Local).AddTicks(5037), 100000m, 200000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi-VN", "Sản phẩm 1", "San-pham-1", "Sản phẩm 1", "Sản phẩm 1" },
                    { 3, 2, "vi-VN", "Sản phẩm 2", "San-pham-2", "Sản phẩm 2", "Sản phẩm 2" },
                    { 2, 1, "en-US", "Product Name 1", "Product-name-1", "The products name 1", "The products name 1" },
                    { 4, 2, "en-US", "Product Name 2", "Product-Name-2", "The Product Name 2", "The Product Name 2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sản phẩm 1", "Sản phẩm 1", "vi-VN", "Sản phẩm 1", 1, "San-pham-1", "Sản phẩm 1", "Sản phẩm 1" },
                    { 2, "Product Name 1", "Product Name 1", "en-US", "Product Name 1", 1, "Product-name-1", "Product Name 1", "Product Name 1" }
                });
